...
$config = [
    'callback' => 'http://localhost/hybridauth/examples/example_01.php', // or Hybridauth\HttpClient\Util::getCurrentUrl()

    'keys' => [ 'id' => GITHUB_ID, 'secret' => GITHUB_SECRET ], // Your Github application credentials
